...
<div class="card-group">
    <?php 
        if($products->relatedProduct($id) > 0):
            foreach($products->relatedProduct($id) as $product):
    ?>
  <div class="card">
    <div><img src="../admin/uploads/<?=$product['pr_img']?>" class="card-img-top" alt="..."></div>
    <div class="card-body">
      <h5 class="card-title"><?=$product['pr_name']?></h5>
      <p class="card-text"><strong>Rs.</strong><?=$product['pr_price']?></p>
